...
def un_article(request, name_article):
	...
	context = {'sous_theme' : sous_theme, 'study_types':study_types , 'le_article': le_article, 'liste_auteurs':l, 'liste_affiliation':liste_affiliation,}
...
def des_articles2(request):
	...
	context = {'liste_articles': liste_articles, 'username': username,}
	return HttpResponse(template.render(context, request))
...
def affiliations3(request):
	...
	context = {'liste_affiliations': liste_affiliations, 'username':username}
	return HttpResponse(template.render(context, request))
...
def journaux3(request):
	...
	context = {'journaux': journaux, 'username':username,}
	return HttpResponse(template.render(context, request))
